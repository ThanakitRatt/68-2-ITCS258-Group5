...
export class SearchBookingsDto {
  @ApiPropertyOptional({
    example: Bookings_status.PENDING,
  ...
  @ApiPropertyOptional({
    ...
    description: 'Return bookings with check-in on or after this date (ISO 8601)',
    type: String,
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    ...
    description: 'Return bookings with check-in on or before this date (ISO 8601)',
    type: String,
  })
  @IsOptional()
  @IsDateString()
